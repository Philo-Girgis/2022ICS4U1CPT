...
public class Levels extends JPanel{
	...
	public void paintComponent(Graphics g){
		...
		//spawn players
		if(intT == 3 && strlevel.equals("Level 1")){
			blnCD = false;
		}else if(intT == 3 && strlevel.equals("Level 2")){
			blnCD = false;
		}else if(intT == 3 && strlevel.equals("Level 3")){
			blnCD = false;
		}else if(intT == 3 && strlevel.equals("Level 4")){
			blnCD = false;
		}else if(intT == 3 && strlevel.equals("Level 5")){
			blnCD = false;
		}
